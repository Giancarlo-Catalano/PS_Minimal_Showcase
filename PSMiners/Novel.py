...
class NovelMiner:
    ...
    def __repr__(self):
        return f"NovelMiner(population_size = {self.population_size})"
    ...
    def step(self):
        ...
        # get offspring
        children = [EvaluatedPS(self.mutation_operator.mutated(parent.ps))
                    for parent in parents
                    for _ in range(self.offspring_amount // len(parents))]
