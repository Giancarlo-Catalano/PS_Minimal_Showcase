...
from PSMiners.AbstractPSMiner import AbstractPSMiner, ResultsAsJSON
from TerminationCriteria import PSEvaluationLimit
from utils import execution_time


def test_algorithm(algorithm_instance: AbstractPSMiner,
...
def get_variants_for_MPL(pRef: PRef,
                         ...
                         mus: list[int]) -> list[AbstractPSMiner]:
...
def get_variants_for_MPLLR(pRef: PRef,
                           ...
                           selection_operators: list[PSSelectionOperator],
                           mus: list[int],
                           food_weights: list[float]) -> list[AbstractPSMiner]:
...
def get_variants_for_archive_miner(pRef: PRef,
                                   metrics: list[Metric],
                                   population_sizes: list[int]) -> list[AbstractPSMiner]:
