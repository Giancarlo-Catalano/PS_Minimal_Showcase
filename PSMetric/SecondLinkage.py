...
class NormalisedLinkage(Metric):
    ...
    def get_linkage_table(pRef: PRef) -> LinkageTable:
        normalised_pRef = pRef.get_with_normalised_fitnesses()
        overall_avg_fitness = np.average(normalised_pRef.fitness_array)
